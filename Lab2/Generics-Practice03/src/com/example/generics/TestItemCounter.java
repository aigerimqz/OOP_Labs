    ...
    public static void main(String[] args) {
        ...
        for(DukeTransaction transaction:transactions) {
        	...
        	switch (transaction.getTransactionType()) {
	        	case "Purchase":currentShirt.addItems(transaction.getCount());
	        	break;
	        	
	        	case "Sale":currentShirt.removeItems(transaction.getCount());
	        	break;
	        	
	        	default: System.out.println("Error: Invalid Transaction Type");
	        	continue;
        	}
        }
